      ...
      <div className="max-w-screen-xl mx-auto px-4 py-20 gap-12 text-gray-600 md:px-8 xl:flex">
        <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
          ...
          <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0 xl:justify-start">
            <a
              href="#"
              className="flex items-center justify-center gap-x-2 py-2 px-4 text-white font-medium bg-brown-500 duration-150 hover:bg-yellow-700 active:bg-gray-900 rounded-lg md:inline-flex font-mono"
            >
